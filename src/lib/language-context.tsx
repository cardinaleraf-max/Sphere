...
export const translations: Record<Locale, Dictionary> = {
  ...
  ar: {
    ...
    about: {
      label: 'من نحن',
      intro:
        'شريك المملكة العربية السعودية متعدد التخصصات في صناعة التجارب للجهات الحكومية والعلامات الفاخرة والمؤسسات ذات الرؤية. يُصمّم كل مشروع بروح المسؤولية والاستدامة والأثر بعيد المدى.',
      philosophyLabel: 'فلسفتنا',
      philosophyLine1: 'حيث تلتقي الضيافة',
      philosophyLine2: 'بالتأثير.',
      philosophyBody:
        'التفكير الاستراتيجي يمنح كل مشروع غايةً واضحة. والتميّز الإبداعي يحوّل الأفكار إلى تجارب لا تُنسى، بينما يضمن التنفيذ المتقن الدقة في كل تفصيل. وانطلاقًا من ضيافة محورها الإنسان، نضع الناس أولًا ونكسب ثقة الجهات الحكومية والعلامات الفاخرة والمؤسسات ذات الرؤية.',
      heritageLabel: 'الإرث',
